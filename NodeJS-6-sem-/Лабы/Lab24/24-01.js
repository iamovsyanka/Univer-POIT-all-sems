...
const client = redis.createClient('//redis-19607.c93.us-east-1-3.ec2.cloud.redislabs.com:19607',
    {password: '3OSxiEkoeCK0HJ7CCm8ultwTRRPCxEml'});

const sequelize = new Sequelize('Casl', 'NodeJS', 'NodeJS', {
    dialect: 'mssql',
    host: 'localhost',
    define: {
        timestamps: false
