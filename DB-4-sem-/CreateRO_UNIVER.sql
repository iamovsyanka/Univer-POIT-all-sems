...
( name = N'RO_UNIVER_ndf', filename = N'D:\Учеба\БД\4lab\RO_UNIVER_ndf.ndf', 
   size = 5120Kb, maxsize = 10240Kb, filegrowth = 10%),
filegroup G1
( name = N'RO_UNIVER11_ndf', filename = N'D:\Учеба\БД\4lab\RO_UNIVER11.ndf', 
   size = 10240Kb, maxsize = 15360Kb, filegrowth = 1024Kb),
( name = N'RO_UNIVER12_ndf', filename = N'D:\Учеба\БД\4lab\RO_UNIVER12.ndf', 
   size = 2048Kb, maxsize = 5120Kb, filegrowth = 1024Kb),
filegroup G2
( name = N'RO_UNIVER21_ndf', filename = N'D:\Учеба\БД\4lab\RO_UNIVER21.ndf', 
   size = 5120Kb, maxsize = 10240Kb, filegrowth = 1024Kb),
( name = N'RO_UNIVER22_ndf', filename = N'D:\Учеба\БД\4lab\RO_UNIVER22.ndf', 
   size = 2048Kb, maxsize = 5120Kb, filegrowth = 1024Kb)
log on
...
create table FACULTY
  (    FACULTY      varchar(10)   constraint  FACULTY_PK primary key,
...
insert into FACULTY   (FACULTY,   FACULTY_NAME )
  ...
  create table  PULPIT 
(   PULPIT   varchar(20)  constraint PULPIT_PK  primary key,
    PULPIT_NAME  varchar(100), 
    FACULTY   varchar(10)   constraint PULPIT_FACULTY_FK foreign key 
...
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )
 ...
 (   TEACHER    varchar(10)  constraint TEACHER_PK  primary key,
     TEACHER_NAME  varchar(100), 
     GENDER     char(1) CHECK (GENDER in ('м', 'ж')),
     PULPIT   varchar(20) constraint TEACHER_PULPIT_FK foreign key 
...
create table SUBJECT
    (     SUBJECT  varchar(10) constraint SUBJECT_PK  primary key, 
           SUBJECT_NAME varchar(100) unique,
           PULPIT  varchar(20) constraint SUBJECT_PULPIT_FK foreign key 
                         references PULPIT(PULPIT)   
     )ON G1;
...
(   AUDITORIUM   varchar(20)  constraint AUDITORIUM_PK  primary key,              
    AUDITORIUM_TYPE     varchar(10) constraint  AUDITORIUM_AUDITORIUM_TYPE_FK foreign key         
...
values  ('206-1', '206-1','ЛБ-К', 15),
  ...
  (   PROFESSION   varchar(20) constraint PROFESSION_PK  primary key,
       FACULTY    varchar(10) constraint PROFESSION_FACULTY_FK foreign key 
                            references FACULTY(FACULTY),
 ...
 insert into PROFESSION(FACULTY, PROFESSION, PROFESSION_NAME, QUALIFICATION)    
             values    ('ИДиП',  '1-40 01 02',   'Информационные системы и тех-нологии', 'инженер-программист-системотехник' ),
...
(   IDGROUP  integer  identity(1,1) constraint GROUP_PK  primary key,              
    FACULTY   varchar(10) constraint  GROUPS_FACULTY_FK foreign key         
                                                         references FACULTY(FACULTY), 
     PROFESSION  varchar(20) constraint  GROUPS_PROFESSION_FK foreign key         
