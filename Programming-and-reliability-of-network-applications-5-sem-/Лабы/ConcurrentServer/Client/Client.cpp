...
int _tmain( int argc, _TCHAR* argv[] ) {
  ...
  try {
    ...
    cin >> chs;
    if ( chs == 1 ) {
      cout << "Соединение с сервером по имени и порту" << endl << "> ";
      ...
      cout << "Соединение с сервером по позывному и порту" << endl << "> ";
      cout << "Введите позыввной сервера: ";
      cin >> Calls;
      SOCKET cC; 
    ...
    while ( !fin ) {
      cout << "Запрос: " << endl << "1 - Rand" << endl << "2 - Time" << endl << "3 - Echo" << endl << "> ";
      cin >> cCall;
    ...
    switch ( cCall ) {
      case 1:
        strcpy_s( Call, "Rand" );
        cout << "Введите команду Rand или другое слово для выхода:" << endl;
        break;
      case 2:
        strcpy_s( Call, "Time" );
        cout << "Введите команду Time или другое слово для выхода:" << endl;
        break;
      case 3:
        strcpy_s( Call, "Echo" );
        cout << "Введите строку для отправки или команду exit для выхода:" << endl;
        break;
      default:
        strcpy_s( Call, "Echo" );
    }
